        ...
        ((input) => {
          ...
          ((input, _path, _exceptionable = true) => {
            const $ao0 = (input, _path, _exceptionable = true) =>
              ...
              (("object" === typeof input.address && null !== input.address) ||
                $guard(_exceptionable, {
                  path: _path + ".address",
                  expected: "Resolve<Address>",
                  value: input.address,
                })) &&
              $ao1(input.address, _path + ".address", true && _exceptionable) &&
            ...
            const $ao1 = (input, _path, _exceptionable = true) =>
              ("string" === typeof input.street ||
                $guard(_exceptionable, {
                  path: _path + ".street",
                  expected: "string",
                  value: input.street,
                })) &&
              ("string" === typeof input.suite ||
                $guard(_exceptionable, {
                  path: _path + ".suite",
                  expected: "string",
                  value: input.suite,
              ...
              ("string" === typeof input.zipcode ||
                $guard(_exceptionable, {
                  path: _path + ".zipcode",
                  expected: "string",
                  value: input.zipcode,
                })) &&
              (("object" === typeof input.geo && null !== input.geo) ||
                $guard(_exceptionable, {
                  path: _path + ".geo",
            ...
            const $ao2 = (input, _path, _exceptionable = true) =>
              ("string" === typeof input.lat ||
                $guard(_exceptionable, {
                  path: _path + ".lat",
                  expected: "string",
                  value: input.lat,
                })) &&
              ("string" === typeof input.lng ||
                $guard(_exceptionable, {
                  path: _path + ".lng",
                  expected: "string",
                  value: input.lng,
            ...
            const $ao3 = (input, _path, _exceptionable = true) =>
              ...
              ("string" === typeof input.catchPhrase ||
                $guard(_exceptionable, {
                  path: _path + ".catchPhrase",
                  expected: "string",
                  value: input.catchPhrase,
                })) &&
              ("string" === typeof input.bs ||
                $guard(_exceptionable, {
                  path: _path + ".bs",
                  expected: "string",
                  value: input.bs,
